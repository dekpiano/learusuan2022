...
<div class="container-fluid">
       ...
       <div class="col-12">       
                   ...
                   <form enctype="multipart/form-data"
                       ...
                       <div class="row">
                           <div class="col-md-6 col-lg-6 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_idCard" name="recruit_idCard"
                                   required value="<?=$recruit[0]->recruit_idCard;?>"
                           ...
                           <div class="col-md-6 col-lg-2 mb-3">
                               ...
                               <input class="form-control" type="text" name="recruit_regLevel" id="recruit_regLevel"
                                   value="<?=$recruit[0]->recruit_regLevel;?>">
                           </div>
                       </div>
                         ...
                         ?>
                           ...
                           <div class="col-md-4 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_firstName" name="recruit_firstName"
                                   value="<?=$recruit[0]->recruit_firstName?>" required>
                               <div class="invalid-feedback">
                                   ระบุชื่อจริง
                               </div>
                           </div>
                           <div class="col-md-4 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_lastName" name="recruit_lastName"
                                   value="<?=$recruit[0]->recruit_lastName?>" required>
                               <div class="invalid-feedback">
                                   ระบุนามสกุล
                               </div>
                           </div>
                       ...
                       <div class="row">
                           <div class="col-md-5 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_oldSchool" name="recruit_oldSchool"
                                   value="<?=$recruit[0]->recruit_oldSchool?>" required>
                               <div class="invalid-feedback">
                           ...
                           <div class="col-md-4 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_district" name="recruit_district"
                                   value="<?=$recruit[0]->recruit_district?>" required>
                               <div class="invalid-feedback">
                           ...
                           <div class="col-md-3 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_province" name="recruit_province"
                                   value="<?=$recruit[0]->recruit_province?>" required>
                               <div class="invalid-feedback">
           ...
           ?>
                   ...
                   foreach ($thaimonth as $key => $v_m) : ?>
                                   <option <?=($M==$key+1 ? 'selected' : '');?> value="<?=sprintf("%02d",$key+1);?>">
                                       <?=$v_m;?></option>
                                   <?php endforeach; ?>
                               </select>
                               <div class="invalid-feedback">
                     ...
                     for ($i=($year-30);$i<=($year);$i++) : ?>
                           ...
                           <div class="col-md-4 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_race" name="recruit_race"
                                   value="<?=$recruit[0]->recruit_race?>" required>
                               <div class="invalid-feedback">
                                   ระบุเชื้อชาติ
                               </div>
                           </div>
                           <div class="col-md-4 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_nationality"
                                   name="recruit_nationality" value="<?=$recruit[0]->recruit_nationality?>" required>
                               <div class="invalid-feedback">
                                   ระบุสัญชาติ
                               </div>
                           </div>
                           <div class="col-md-4 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_religion" name="recruit_religion"
                                   value="<?=$recruit[0]->recruit_religion?>" required>
                               <div class="invalid-feedback">
                                   ระบุศาสนา
                               </div>
                           </div>
                       ...
                       <div class="row">
                           <div class="col-md-3 mb-3">
                               ...
                               <input type="text" class="form-control" id="  recruit_homeNumber"
                                   name=" recruit_homeNumber" value="<?=$recruit[0]->recruit_homeNumber?>" required>
                               <div class="invalid-feedback">
                                   ระบุเลขที่บ้าน
                               </div>
                           </div>
                           <div class="col-md-2 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_homeGroup" name="recruit_homeGroup"
                                   value="<?=$recruit[0]->recruit_homeGroup;?>" required>
                               <div class="invalid-feedback">
                                   ระบุหมู่ที่
                               </div>
                           </div>
                           <div class="col-md-3 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_homeRoad" name="recruit_homeRoad"
                                   value="<?=$recruit[0]->recruit_homeRoad?>">
                               <div class="invalid-feedback">
                                   ระบุถนน
                               </div>
                           </div>
                       ...
                       <div class="row">
                           <div class="col-md-5 mb-3">
                               ...
                               <input type="text" class="form-control" id="recruit_phone" name="recruit_phone"
                                   value="<?=$recruit[0]->recruit_phone?>" required
   ...
   foreach ($confrim as $key => $value) : ?>
                           ...
                           <div class="custom-control custom-radio">
                               <input <?=$value == $recruit[0]->recruit_status ? 'checked' : ''?> type="radio"
                                   id="recruit_status<?=$key;?>" name="recruit_status" class="custom-control-input"
                                   value="<?=$value;?>">
