...
<div class="container-fluid mt-5">
    ...
    <div class="card shadow mb-4 ">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary justify-content-between">ตารางข้อมูล<?=$title;?> </h6>
            <div class="dropdown no-arrow">
            <a target="_blank" href="<?=base_url('admin/control_admin_admission/pdf_all');?>" class="btn btn-primary btn-sm"><i class="fas fa-print"></i> พิมพ์ใบสมัครทั้งหมด</a> 
            </div>
        </div>
        <div class="card-body">
